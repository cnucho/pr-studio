...
const clips = [
  ...
  {
    id: "10-writing-output",
    image: "writing-output.png",
    caption: "AI 친화 글쓰기 설계: 프레임, FAQ, 검증 게이트, handoff",
    narration:
      "새로 흡수한 기능은 AI 친화 글쓰기 설계입니다. ReportDesk의 스토리라인 우선 흐름과 gWriter의 검증형 작성 원칙을 가볍게 가져와, 답변 우선형, 근거 순회형, 주의점 우선형, FAQ 의미망형 중 적합한 프레임을 제안합니다. 동시에 출처 경고와 검증 체크리스트, 다음 편집 도구로 넘길 handoff 패키지를 만듭니다.",
  },
  {
    id: "11-targeting-strategy",
    image: "targeting-strategy.png",
    caption: "마이크로타겟팅: 시민 상태별 메시지 전략",
    narration:
      "다섯 번째 데모는 상태 기반 마이크로타겟팅입니다. 같은 정책 대상자라도 어떤 사람은 정보를 몰라서 움직이지 않고, 어떤 사람은 기준을 믿지 못해서 멈춥니다. 앱은 시민 상태를 나누고, 목표에 따라 메시지, 근거, 다음 행동을 다르게 제안합니다.",
  },
  {
    id: "12-performance-collector",
    image: "performance-collector.png",
    caption: "성과 수집: YouTube 공개 지표와 다음 메시지 실험",
    narration:
      "여섯 번째 데모는 유튜브 성과 수집기입니다. 배포된 영상의 조회수, 좋아요, 댓글 같은 공개 지표를 모아 어떤 제목과 썸네일 약속이 반응을 만들었는지 비교합니다. 이렇게 되면 홍보는 일회성 캠페인이 아니라 다음 메시지를 더 정확하게 만드는 학습 루프가 됩니다.",
  },
  {
    id: "13-future",
    image: "scene-10-future.png",
